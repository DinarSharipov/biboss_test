...
!function (e, t) {
  ...
  var C = function (e) {
    ...
    }, n.sortStable = b.split("").sort(j).join("") === b, n.detectDuplicates = !!f, p(), n.sortDetached = ue(function (e) {
  ...
  (b.fn.init = function (e, t, n) {
    ...
    if (n = n || A, "string" == typeof e) {
      ...
      if (i[1]) {
        if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)), D.test(i[1]) && b.isPlainObject(t)) for (i in t) {
            ...
            return function () {
              var s = this,
                ...
                if (!(t < o)) {
                  ...
                  l = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, g(l) ? i ? l.call(e, a(o, n, M, i), a(o, n, R, i)) : (o++, l.call(e, a(o, n, M, i), a(o, n, R, i), a(o, n, M, n.notifyWith))) : (r !== M && (s = void 0, u = [e]), (i || n.resolveWith)(s, u));
                }
              },
                  c = i ? l : function () {
                try {
  ...
  b.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && b.find.matchesSelector(me, i), n.guid || (n.guid = b.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
        ...
        d = g = (s = be.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = b.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = b.event.special[d] || {}, c = b.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
  ...
  function Oe(e, t, n, r) {
    ...
    var i,
        ...
        v = t[0],
        m = g(v);
    if (m || p > 1 && "string" == typeof v && !h.checkClone && je.test(v)) return e.each(function (i) {
      var o = e.eq(i);
      m && (t[0] = v.call(this, i, o.html())), Oe(o, t, n, r);
    });

    if (p && (o = (i = ve(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
      for (u = (s = b.map(de(i, "script"), Ae)).length; f < p; f++) {
        l = i, f !== d && (l = b.clone(l, !0, !0), u && b.merge(s, de(l, "script"))), n.call(e[f], l, f);
      }

      if (u) for (c = s[s.length - 1].ownerDocument, b.map(s, qe), f = 0; f < u; f++) {
        l = s[f], fe.test(l.type || "") && !Y.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && b._evalUrl(l.src) : y(l.textContent.replace(De, ""), c, l));
      }
    }
  ...
  function Ie(e, t, n) {
    var r,
        ...
        a,
        s = e.style;
    return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || b.contains(e.ownerDocument, e) || (a = b.style(e, t)), !h.pixelBoxStyles() && Me.test(a) && $e.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a;
  }
  ...
  b.extend({
    ...
    css: function css(e, t, n, r) {
      var i,
          ...
          a,
          s = U(t);
      return Fe.test(t) || (t = Ve(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ie(e, t, r)), "normal" === i && t in ze && (i = ze[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  ...
  b.extend(b.event, {
    trigger: function trigger(t, n, i, o) {
      ...
      if (s = h = u = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !gt.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (y = (x = y.split(".")).shift(), x.sort()), c = y.indexOf(":") < 0 && "on" + y, (t = t[b.expando] ? t : new b.Event(y, "object" == _typeof(t) && t)).isTrigger = o ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : b.makeArray(n, [t]), d = b.event.special[y] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
        if (!o && !d.noBubble && !v(i)) {
          for (l = d.delegateType || y, gt.test(l + y) || (s = s.parentNode); s; s = s.parentNode) {
            m.push(s), u = s;
          }
        ...
        for (a = 0; (s = m[a++]) && !t.isPropagationStopped();) {
          h = s, t.type = a > 1 ? l : d.bindType || y, (p = (Y.get(s, "events") || {})[t.type] && Y.get(s, "handle")) && p.apply(s, n), (p = c && s[c]) && p.apply && V(s) && (t.result = p.apply(s, n), !1 === t.result && t.preventDefault());
        }

        return t.type = y, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(m.pop(), n) || !V(i) || c && g(i[y]) && !v(i) && ((u = i[c]) && (i[c] = null), b.event.triggered = y, t.isPropagationStopped() && h.addEventListener(y, vt), i[y](), t.isPropagationStopped() && h.removeEventListener(y, vt), b.event.triggered = void 0, u && (i[c] = u)), t.result;
      }
    },
  ...
  Ot.href = mt.href, b.extend({
    ...
    ajax: function ajax(t, n) {
      ...
      if (m.promise(E), h.url = ((t || h.url || mt.href) + "").replace(At, mt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(P) || [""], null == h.crossDomain) {
        l = r.createElement("a");
  ...
  h.cors = !!It && "withCredentials" in It, h.ajax = It = !!It, b.ajaxTransport(function (t) {
    ...
    if (h.cors || It && !t.crossDomain) return {
      send: function send(i, o) {
        ...
        _n = function n(e) {
          return function () {
            _n && (_n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o($t[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
              binary: s.response
            } : {
              text: s.responseText
  ...
  b.ajaxSetup({
    ...
    if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Bt, "$1" + i) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
      ...
      void 0 === o ? b(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Wt.push(i)), a && g(o) && o(a[0]), a = o = void 0;
    }), "script";
  }), h.createHTMLDocument = function () {
    var e = r.implementation.createHTMLDocument("").body;
    return e.innerHTML = "<form></form><form></form>", 2 === e.childNodes.length;
  }(), b.parseHTML = function (e, t, n) {
    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (h.createHTMLDocument ? ((i = (t = r.implementation.createHTMLDocument("")).createElement("base")).href = r.location.href, t.head.appendChild(i)) : t = r), a = !n && [], (o = D.exec(e)) ? [t.createElement(o[1])] : (o = ve([e], t, a), a && a.length && b(a).remove(), b.merge([], o.childNodes)));
    var i, o, a;
  ...
  }, b.isArray = Array.isArray, b.parseJSON = JSON.parse, b.nodeName = j, b.isFunction = g, b.isWindow = v, b.camelCase = U, b.type = x, b.now = Date.now, b.isNumeric = function (e) {
    var t = b.type(e);
  ...
  $(document).ready(function () {
    $(".js-head-btn").on("click", function () {
      $(".js-menu-container").addClass("active"), $("body").addClass("disable"), $(".js-menu-btn").addClass("close");
    });
  }), $(document).ready(function () {
    $(".js-menu-btn").on("click", function () {
      $(".js-menu-container").removeClass("active"), $("body").removeClass("disable"), $(".js-menu-btn").removeClass("close");
    });
  }), $(document).mouseup(function (e) {
    var t = $(".js-menu-container");
    !t.is(e.target) && 0 === t.has(e.target).length && t.hasClass("active") && (t.removeClass("active"), $("body").removeClass("disable"), $(".js-menu-btn").removeClass("close"));
  });
});